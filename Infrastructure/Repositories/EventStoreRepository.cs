...
using Scheduling.Infrastructure.Exceptions;
using Scheduling.Infrastructure.Factories;
using Scheduling.Infrastructure.Model;
...
namespace Scheduling.Infrastructure.Repositories
{
    public class EventStoreRepository : IEventStore
    {
            ...
            , IReadOnlyCollection<IDomainEvent> events, string aggregateName = "Aggregate Name")
        {
            ...
            //TODO add a message to service bus queue
            //This message will be picked by another process and Appointments table will be updated
        }
    }
}